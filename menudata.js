    ...
    en: {
        categories: {
            "Salads": [
                ...
                { name: "Zucchini Carpaccio", price: "€12", description: "Zucchini slices with olive oil and seasoning", image: "salad5.jpg" }
            ],
            "Starters": [
                { name: "Tomato & Garlic Bread", price: "€4.80", description: "Toasted bread with tomato and ajoaceite", image: "starter1.jpg" },
                { name: "Fried Eggplant with Honey", price: "€9.80", description: "Eggplant fries drizzled with honey", image: "starter2.jpg" },
    ...
    fr: {
        categories: {
            "Salades": [
                ...
                { name: "Carpaccio de Courgette", price: "€12", description: "Tranches de courgette avec de l'huile d'olive", image: "salad5.jpg" }
            ],
            "Entrées": [
                { name: "Pain Tomate et Ajoaceite", price: "€4.80", description: "Pain grillé avec tomate et ajoaceite", image: "starter1.jpg" },
    ...
    es: {
        categories: {
            "Ensaladas": [
                ...
                { name: "Ensalada César (Pollo)", price: "€14", description: "Ensalada César clásica con pollo", image: "Combination-chicken.jpeg" },
                ...
                { name: "Carpaccio de Calabacín", price: "€12", description: "Rodajas de calabacín con aceite de oliva", image: "salad5.jpg" }
            ],
            "Entrantes": [
                { name: "Pan con Tomate y Ajoaceite", price: "€4.80", description: "Pan tostado con tomate y ajoaceite", image: "starter1.jpg" },
                { name: "Berenjenas Fritas con Miel", price: "€9.80", description: "Berenjenas fritas con miel", image: "starter2.jpg" },
                { name: "Calamares Fritos", price: "€9.90", description: "Calamares fritos crujientes con limón", image: "starter3.jpg" },
                { name: "Croquetas de Jamón Ibérico", price: "€9.60", description: "Croquetas de jamón ibérico crujientes", image: "starter4.jpg" },
                { name: "Patatas con Queso y Bacon", price: "€9.90", description: "Patatas fritas cubiertas con queso gouda y bacon", image: "starter5.jpg" }
            ],
            "Combinados": [
                { name: "Embutidos Montanejos", price: "€11", description: "Embutidos variados con un huevo frito y patatas", image: "starter1.jpg" },
                { name: "Pulpo Vidigonero", price: "€18", description: "Pulpo Vidigonero", image: "Specialties-octopus.jpeg" },
                { name: "Pollo Empanado", price: "€11", description: "Pollo empanado con patatas y huevo frito", image: "Combination-chicken.jpeg" },
                { name: "Sepia Plancha", price: "€16", description: "Sepia a la plancha", image: "starter4.jpg" },
                { name: "Calamares Rebozados", price: "€13", description: "Calamares rebozados con patatas fritas", image: "Combination-calamary.jpeg" },
                { name: "Emperador Salsa Verde", price: "€15", description: "Pescado emperador con salsa verde", image: "Combination-swordfish.jpeg" }
            ]
            // Add other categories following the same structure as English
        }
    }
